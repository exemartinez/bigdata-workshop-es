...
hd5f_file='/home/osboxes/Documents/bigdata-workshop-es/dataset/trainingsetv1d1.h5'
pickle_file='/home/osboxes/Documents/bigdata-workshop-es/dataset/gw_consolidated_matrix.pickle'

hf = h5py.File(hd5f_file, 'r')

#first, we get the dataframe in pandas with all the headers for the data.
csv = '/home/osboxes/Documents/bigdata-workshop-es/dataset/trainingset_v1d1_metadata.csv'
